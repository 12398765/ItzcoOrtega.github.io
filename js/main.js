...
document.querySelector(".fetch_crud").addEventListener("click", () => {
    Swal.fire({
        title: 'Lo siento',
        text: "Este proyecto no cuenta con una página web, pero puedes visitar el código empleado desde github",
        icon: 'warning',
        time: 3000
    })
})
